...
class System {
 public:
   ...
   *
   * @return constexpr zstring_view
   */
  static constexpr zstring_view operating_system_name() { return kOperatingSystemName[operating_system()]; }
   ...
   * @return zstring_view
   */
  std::optional<zstring_view> driver_name() { return kDriverName[driver_]; }
   ...
   * @return std::filesystem::path
   */
  static std::filesystem::path utf8str_to_path(zstring_view str_path);
