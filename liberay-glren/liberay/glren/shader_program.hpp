...
class ShaderProgram {
 public:
  explicit ShaderProgram(util::zstring_view name);
 ...
 protected:
  ...
  //   void bind_uniform_buffer(util::zstring_view name, const UniformBuffer& ubo) const;
...
class RenderingShaderProgram : public ShaderProgram {
 public:
  static std::expected<std::unique_ptr<RenderingShaderProgram>, ProgramCreationError> create(
      util::zstring_view name, GLSLShader vert_shader, GLSLShader frag_shader,
 ...
 private:
  RenderingShaderProgram(util::zstring_view name, GLSLShader&& vert_shader, GLSLShader&& frag_shader,
...
//  public:
//   ComputeShaderProgram(util::zstring_view name, GLSLShader compute_shader);
