...
VertexArrays VertexArrays::create(std::unordered_map<util::zstring_view, VertexBuffer>&& vert_buffs,
...
void VertexArrays::set_binding_divisor(util::zstring_view name, GLuint divisor) {  // NOLINT
