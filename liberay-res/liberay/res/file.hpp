...
/**
 * @brief Validates if the file exists and is not a directory. If extensions are provided, the function checks if the
 ...
 */
static util::Result<void, FileError> validate_file(const std::filesystem::path& path,
